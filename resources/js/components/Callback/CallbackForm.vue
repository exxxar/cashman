                        ...
                        <form @submit.prevent="sendMessage"
                            ...
                            <div class="form-group basic animated">
                                <div class="input-wrapper">
                                    ...
                                    <input v-model="form.name" type="text" class="form-control" id="name2" placeholder="Ваше имя">
                                    <i class="clear-input">
                            ...
                            <div class="form-group basic animated">
                                <div class="input-wrapper">
                                    ...
                                    <input v-model="form.email" type="text" class="form-control" id="email2" placeholder="Почта">
                                    <i class="clear-input">
                                        <ion-icon name="close-circle-outline"></ion-icon>
                                    </i>
                                </div>
